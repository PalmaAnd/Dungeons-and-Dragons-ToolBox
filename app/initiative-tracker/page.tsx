...
import { PlusCircle, Trash2, Swords, Shield, Heart } from 'lucide-react'
import {
    Card,
    CardContent,
    CardHeader,
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            ...
            <Card className="mb-6">
                ...
                <CardContent>
                    <form onSubmit={addCombatant} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        <div>
            ...
            <div className="flex gap-4 mb-6">
                <Button onClick={startCombat} disabled={isCombatActive || combatants.length === 0}>
            ...
            <div className="grid gap-4">
                {combatants.map((combatant, index) => (
                    <Card
                        key={combatant.id}
                        className={`${index === currentTurn && isCombatActive ? 'border-primary' : ''}`}
                    >
                        <CardContent className="flex items-center justify-between p-4">
                            <div className="flex items-center gap-4">
                                <span className="text-2xl font-bold">{combatant.initiative}</span>
                                <div>
